...
Feature: Authoring content
  ...
  Scenario: Author a Textile post
    Given I have a post "x.textile" with metadata:
      | field      | value                              |
      | kind       | article                            |
      ...
      | entity id  | 1                                  |
    And I have a post "x.textile" with content:
      """
  ...
  Scenario: Author a Markdown post
    Given I have a post "y.markdown" with metadata:
      | field      | value                               |
      | kind       | article                             |
      ...
      | created at | 2010-10-01 12:34                    |
      | entity id  | 1                                   |
    And I have a post "y.markdown" with content:
      """
  ...
  Scenario: Prevent authoring two posts with identical identifiers
    Given I have a post "a.textile" with metadata:
      | field     | value   |
      | kind      | article |
      | stub      | x       |
      | entity id | 1       |
    And I have a post "b.textile" with metadata:
      | field     | value   |
      | kind      | article |
      | stub      | y       |
      | entity id | 1       |
    And I have a post "a.textile" with content:
      """
      p. This is Textile post one.
      """
    And I have a post "b.textile" with content:
      """
